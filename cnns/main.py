...
SUPPORTED_DATASETS = {
    ...
    "imagenet_option1":
        (imagenet.Imagenet, dataset.pre_process_option1, dataset.PostProcessArgMax(offset=0),
         {"image_size": [224, 224, 3]}),
    "imagenet_torch":
...
SUPPORTED_PROFILES = {
    ...
    "pytorch-openvino": {
        "dataset": "imagenet_torch",
        "backend": "openvino",
        "cache": 0,
        "max-batchsize": 32,
    },
    "wcc-openvino": {
        "dataset": "imagenet_wcc",
        "backend": "openvino",
        "data-format": "NCHW",
        "cache": 0,
        "max-batchsize": 32,
...
def get_args():
    ...
    parser.add_argument(
        "--model-name", default="resnet50", help="name of the mlperf model, ie. resnet50")
...
def main():
    ...
    # FIXME: CHANGED THIS TO FIT SUBMISSION CHECKER
    if args.accuracy:
    ...
    qsl = lg.ConstructQSL(count, min(count, 1024),
